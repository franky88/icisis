...
class StudentInfoAdmin(admin.ModelAdmin):
	list_display = ['student', 'gender', 'address', 'father_name', 'mother_name', 'timestamp', 'date_updated']
	search_fields = ['student']
	list_filter = ['timestamp']

class StudentAdmin(admin.ModelAdmin):
	list_display = ['full_name', 'lrn_or_id_number', 'birth_day', 'department', 'course', 'timestamp', 'date_updated']
